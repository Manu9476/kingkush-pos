...
const explicitCollections: Record<string, ExplicitConfig> = {
  ...
  settings: {
    ...
    fieldMap: {
      ...
      receiptPaperWidthMm: { column: 'receipt_paper_width_mm', type: 'integer' },
      receiptFontSizePx: { column: 'receipt_font_size_px', type: 'integer' },
      receiptBrandColor: { column: 'receipt_brand_color', type: 'text' },
      receiptSaleTitle: { column: 'receipt_sale_title', type: 'text' },
      receiptRefundTitle: { column: 'receipt_refund_title', type: 'text' },
      receiptCreditTitle: { column: 'receipt_credit_title', type: 'text' },
      receiptExpenseTitle: { column: 'receipt_expense_title', type: 'text' },
      receiptShiftTitle: { column: 'receipt_shift_title', type: 'text' },
      receiptShowBranchName: { column: 'receipt_show_branch_name', type: 'boolean' },
      receiptShowAddress: { column: 'receipt_show_address', type: 'boolean' },
      receiptShowPhone: { column: 'receipt_show_phone', type: 'boolean' },
      receiptShowEmail: { column: 'receipt_show_email', type: 'boolean' },
      receiptShowHeader: { column: 'receipt_show_header', type: 'boolean' },
      receiptShowFooter: { column: 'receipt_show_footer', type: 'boolean' },
      receiptShowCashier: { column: 'receipt_show_cashier', type: 'boolean' },
      receiptShowCustomer: { column: 'receipt_show_customer', type: 'boolean' },
      receiptShowReference: { column: 'receipt_show_reference', type: 'boolean' },
      receiptShowTaxLine: { column: 'receipt_show_tax_line', type: 'boolean' },
      receiptShowLoyaltySummary: { column: 'receipt_show_loyalty_summary', type: 'boolean' },
    ...
    writableFields: [
      ...
      'receiptShowCashier',
      'receiptShowCustomer',
      'receiptShowReference',
      'receiptShowTaxLine',
      'receiptShowLoyaltySummary',
      'drawerEnabled',
    ...
    serialize: (row) => ({
      ...
      receiptPaperWidthMm: Number(row.receipt_paper_width_mm ?? 80),
      receiptFontSizePx: Number(row.receipt_font_size_px ?? 12),
      receiptBrandColor: row.receipt_brand_color,
      receiptSaleTitle: row.receipt_sale_title,
      receiptRefundTitle: row.receipt_refund_title,
      receiptCreditTitle: row.receipt_credit_title,
      receiptExpenseTitle: row.receipt_expense_title,
      receiptShiftTitle: row.receipt_shift_title,
      receiptShowBranchName: row.receipt_show_branch_name === undefined ? true : Boolean(row.receipt_show_branch_name),
      receiptShowAddress: row.receipt_show_address === undefined ? true : Boolean(row.receipt_show_address),
      receiptShowPhone: row.receipt_show_phone === undefined ? true : Boolean(row.receipt_show_phone),
      receiptShowEmail: row.receipt_show_email === undefined ? true : Boolean(row.receipt_show_email),
      receiptShowHeader: row.receipt_show_header === undefined ? true : Boolean(row.receipt_show_header),
      receiptShowFooter: row.receipt_show_footer === undefined ? true : Boolean(row.receipt_show_footer),
      receiptShowCashier: row.receipt_show_cashier === undefined ? true : Boolean(row.receipt_show_cashier),
      receiptShowCustomer: row.receipt_show_customer === undefined ? true : Boolean(row.receipt_show_customer),
      receiptShowReference: row.receipt_show_reference === undefined ? true : Boolean(row.receipt_show_reference),
      receiptShowTaxLine: row.receipt_show_tax_line === undefined ? true : Boolean(row.receipt_show_tax_line),
      receiptShowLoyaltySummary: row.receipt_show_loyalty_summary === undefined ? true : Boolean(row.receipt_show_loyalty_summary),
