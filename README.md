...
- `api/auth.ts` - compact Vercel entrypoint for login, logout, and session lookup
- `api/transactions.ts` - compact Vercel entrypoint for sale, refund, inventory, credit, and PO flows
